...
export default function SearchingSorting25(props) {
    return <>
        <NavBar />
        <div className="split">
            <Question 
                name="Book Allocation Problem"
                statement={`Ayush is studying for ninjatest which will be held after 'N' days, And to score good marks he has to study 'M' chapters and the ith chapter requires TIME[i] seconds to study. The day in Ayush’s world has 100^100 seconds. There are some rules that are followed by Ayush while studying.
                ...
                input={`The first line of the input contains a single positive integer 'T', denoting the number of test cases.
                ...
                `}
                output={`For each test case print a single line containing a single integer denoting the maximum time Ayush studies in a day.
                ...
                1 2 2 3 1`}
                sampleoutput1={`4`}
                explanation1={`The ayush will read the chapter as follows,
                ...
                2 2 3 3 4 4 1 `}
                sampleoutput2={`6`}
                explanation2={`The ayush will read the chapter as follows,
                ...
                />
            <Code file_link="/searching_and_sorting/searching_and_sorting_25" />
        </div>
    </>
}