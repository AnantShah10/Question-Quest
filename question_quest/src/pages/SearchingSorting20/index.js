...
export default function SearchingSorting20(props) {
    return <>
        <NavBar />
        <div className="split">
            <Question 
                name="Rasta and Kheshtak"
                statement={`Rasta is a big fan of Kheshtaks. A Kheshtak is a rectangle that in each of it cells there is an integer.
                ...
                input={`The first line of input contains n and m.
                ...
                `}
                output={`Print the size of BCS of A and B in a single line (size of a Square is number of its rows).`}
                constraints={`1 ≤ n, m, x, y ≤ 700 and all numbers in A and B are integers in the interval [1, 1000].`}
                sampleinput1={`3 3
                1 2 0
                1 2 1
                1 2 3
                ...
                sampleoutput1={`2`}
                />
            <Code file_link="/searching_and_sorting/searching_and_sorting_20" />
        </div>
    </>
}